...
#Very nearly did it! Close but produced a multi-dimensional array rather than a 1d one- overuse of array here where I was shovelling into an array when it should have been a hash.
# def staircase(num)
#   range_array = []
...
#   odds_key = range.select { |num| num.odd? }
#
#   odds_key.each {|char| Hash[char] = (1..e).to_a.select { |num| num.even? } }
# end
#
# odds_evens_key = {odds_key => evens_value}
# end
